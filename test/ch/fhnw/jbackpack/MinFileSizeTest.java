 ...
 */
public class MinFileSizeTest extends TestCase {
    ...
    public void testMaxFileSize() throws Exception {
        ...
        try {
            ...
            preferences.putBoolean(BackupMainPanel.EXCLUDE_LARGE_FILES, false);
            preferences.putBoolean(BackupMainPanel.EXCLUDE_SMALL_FILES, true);
            preferences.putLong(BackupMainPanel.MIN_FILE_SIZE, size + 1);
            preferences.putInt(BackupMainPanel.MIN_FILE_SIZE_UNIT, 0);
